...
function draw() {
  ...
  color.r = random(178,180),
  color.g = random(239,240);
  spot.x = random(0,window.innerWidth);
  spot.y = random(0,window.innerHeight);
  ellipse(spot.x, spot.y, 40, 40, 20);
  fill(col.r, col.g, col.b, 150);
 noStroke();
